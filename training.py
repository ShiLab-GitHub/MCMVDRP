...
from models.gat_gcn_smile import GAT_GCN_SMILES
from models.gat_gcn_fingerprint import GAT_GCN_Fingerprint
from models.gat_gcn_fingerprint_graph import GAT_GCN_Fingerprint_Graph
from models.gat_gcn_fingerprint_smile import GAT_GCN_Fingerprint_SMILES
from models.gat_gcn_graph_smile import GAT_GCN_Graph_SMILES
from models.gat_gcn_graph import GAT_GCN_Graph
from utils import *
import datetime
import argparse
import gc
        ...
        for epoch in range(num_epoch):
            ...
            if ret_test[0]<best_rmse:
                ...
                if ret_test[1] < best_mse:
                    best_mse = ret_test[1]
                if ret_test[2] > best_pearson:    
                    best_pearson = ret_test[2]
                print(' rmse improved at epoch ', best_epoch, '; best_mse:', best_mse,'best_rmse:', best_rmse,'; best_pearson:',best_pearson, model_st,dataset)
            else:
                print(' no improvement since epoch ', best_epoch,'; best_mse:', best_mse, '; best_rmse:', best_rmse,'; best_pearson:', best_pearson, model_st, dataset)
...
if __name__ == "__main__":
    ...
    modeling = [GAT_GCN_Fingerprint_SMILES][args.model]
