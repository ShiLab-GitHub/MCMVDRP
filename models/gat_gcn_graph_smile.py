...
class GAT_GCN_Graph_SMILES(torch.nn.Module):
    def __init__(self, n_output=1, num_features_xd=78, num_features_xt=25,
                 n_filters=32, embed_dim=128, output_dim=128, dropout=0.2):

        super(GAT_GCN_Graph_SMILES, self).__init__()
        ...
        #self.conv_xds_1 = nn.GRU(256, embed_dim, num_layers=2, batch_first=True, bidirectional=True)
